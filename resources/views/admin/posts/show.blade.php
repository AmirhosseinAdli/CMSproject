...
<div class="card" style="width: 18rem;">
    ...
    <div class="card-body">
        ...
        <form action="{{route('admin.posts.activation',[$post])}}" method="get">
            @csrf
            <button type="submit" class="btn btn-warning btn-sm active" onclick="return confirm('آیا از غیر فعال کردن این پست مطمئن هستید؟')">
