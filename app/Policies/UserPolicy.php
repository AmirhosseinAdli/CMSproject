...
class UserPolicy
{
    ...
    {
        return
            str_contains($user->getRoleNames(), 'admin')
            ||
    ...
    {
//        return $user->can("delete-{$model->getRoleNames()->first()}");
//        return $user->hasPermissionTo('delete-user');
//        return $user->getRoleNames()->first() == 'super-admin' || $user->getRoleNames()->first() == 'admin';
    }
